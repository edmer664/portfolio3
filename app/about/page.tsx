  ...
  return (
    <>
      ...
      <div className="container mx-auto px-5">
        <div className="flex flex-wrap items-center justify-center md:justify-between min-h-screen 2xl:min-h-[1080px]">
        ...
        <div className="flex justify-center items-center min-h-screen 2xl:min-h-[1080px] py-20">
          <div
        ...
        <div className="flex flex-wrap-reverse items-center justify-center md:justify-between min-h-screen 2xl:min-h-[1080px] py-20">
        ...
        <div className="flex flex-wrap items-center justify-center md:justify-between min-h-screen 2xl:min-h-[1080px] py-20">
          <div className="md:w-1/2">
            <Image
